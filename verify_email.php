...
if (isset($_POST['verify_otp'])) {
    ...
    if ($otp == $_SESSION['otp']) {
        // Update the database to set the OTP column to NULL
        $email = $_SESSION['email']; // Assuming you store the user's email in session
        $query = "UPDATE student SET otp = NULL WHERE email = ?";
